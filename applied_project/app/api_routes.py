...
import requests, os, json, hashlib, re, traceback
import numpy as np

from .models import db, ReviewHistory, SentimentSnapshot, CompetitorCache
from .utils import extract_adjectives_and_competitors, fetch_competitor_names, get_nlp, get_sentiment_pipeline
